   ...
   <Link className="navbar-brand" to="/">Brayan Cadavid</Link>
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="navbar-nav">
        ...
        <a href="https://api.whatsapp.com/send?phone=573113889619&text= Hola!%20Quiero%20contratar%20sus%20servicios!"><img id="wasap" src="https://i.pinimg.com/originals/57/93/fa/5793fa77a347969c747ecf703c2aee90.png" alt="wasa"></img></a>
